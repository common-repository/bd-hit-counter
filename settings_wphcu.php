...
function wphcu_menu() {
  add_options_page('Bliss Hit Counter Options', 'Bliss Hit Counter', 'administrator', 'bd-hit-counter', 'wphcu_options');
}
...
function wphcu_options() {
    ...
    <h2>Bliss Hit Counter Settings</h2>

    <form method="post" action="options.php">
        <?php settings_fields( 'bd-hit-counter-group' ); ?>
        <?php
            $data = file_array(WP_CONTENT_DIR . '/plugins/bd-hit-counter/designs/');
    ...
    <?php
                foreach ($style as $name) {
                	...
                	<tr>
                		...
                		<img src='<?php echo WP_PLUGIN_URL?>/bd-hit-counter/designs/<?php echo $style_name . '/' . $name . '/'; ?>1.gif'>
                		<img src='<?php echo WP_PLUGIN_URL?>/bd-hit-counter/designs/<?php echo $style_name . '/' . $name . '/'; ?>2.gif'>
                		<img src='<?php echo WP_PLUGIN_URL?>/bd-hit-counter/designs/<?php echo $style_name . '/' . $name . '/'; ?>3.gif'>
                		</td>
                	</tr>
                    <?php
                }
